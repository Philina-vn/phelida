...
public class AuthController {
    ...
    public ResponseEntity<AuthResponseDto> registerUser(@RequestBody RegistrationRequestDto dto) {
        return ResponseEntity.ok(authService.registerUser(dto));
    }

    @PostMapping("/register/admin")
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<AuthResponseDto> registerAdmin(@RequestBody RegistrationRequestDto dto) {
